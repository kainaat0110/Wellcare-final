...
list_to_train =[
    ...
    "1.a.1",
    "You're welcome! I hope you're feeling much better now. Sometimes it can help to talk about what's going on and get things off your chest.🫂<br>If you wish to continue please choose another mood from the starting list else it was nice talking to you see ya.",
    "1.a.2",
    ...
    "2.a.1",
    "You're welcome! I hope you're feeling much better now. Sometimes it can help to talk about what's going on and get things off your chest.🫂If you wish to continue please choose another mood from the starting list else it was nice talking to you see ya.",
    "2.a.2",
    ...
    "4.a",
    "Sure, here's a joke for you: <br> Why couldn't the bicycle stand up by itself?🚲 <br> Because it was two-tired! <br> <br> Please select one from the options below: <br> 4.b.1 Hahaha! That was hilarious.😂 <br> 4.b.2 Tell me another joke.",
    "4.b.1",
    "I'm glad you enjoyed it!😉 If you wish to continue please choose another mood from the starting list else it was nice talking to you see ya.",
    "4.b.2"
